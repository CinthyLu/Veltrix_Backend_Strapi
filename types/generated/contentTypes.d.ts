...
export interface ApiProgramerProgramer extends Struct.CollectionTypeSchema {
  collectionName: 'programers';
  info: {
    displayName: 'Programmer';
    pluralName: 'programers';
    singularName: 'programer';
  };
  options: {
  ...
  attributes: {
    ...
    Identifier: Schema.Attribute.UID<'Full_name'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Featured: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    Full_description: Schema.Attribute.Text;
    Identifier: Schema.Attribute.UID<'Project_Name'> &
      Schema.Attribute.Required;
    Link_demo: Schema.Attribute.String;
    Link_repository: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::project.project'
    ...
    Main_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    programmers: Schema.Attribute.Relation<
      'manyToMany',
      'api::programer.programer'
    >;
    ...
    Technologies_used: Schema.Attribute.String & Schema.Attribute.Required;
    tipo_de_proyecto: Schema.Attribute.Enumeration<
